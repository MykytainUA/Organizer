...
public class LoginAndRegisterView {
	...
	private JButton loginRegisterNewAccountButton;
	private JButton registerGoBackToSignInButton;
	private JButton loginSignInButton;
	private JButton registerSignUpButton;
	...
	public JButton getLoginRegisterNewAccountButton() {
		return loginRegisterNewAccountButton;
	}

	public void setLoginRegisterNewAccountButton(JButton loginRegisterNewAccountButton) {
		this.loginRegisterNewAccountButton = loginRegisterNewAccountButton;
	}

	public JButton getLoginSignInButton() {
		return loginSignInButton;
	}

	public void setLoginSignInButton(JButton loginSignInButton) {
		this.loginSignInButton = loginSignInButton;
	}

	public JTextField getLoginLoginField() {
		return loginLoginField;
	}

	public void setLoginLoginField(JTextField loginLoginField) {
		this.loginLoginField = loginLoginField;
	}
	...
	public JTextField getRegisterLoginField() {
		return registerLoginField;
	}

	public void setRegisterLoginField(JTextField registerLoginField) {
		this.registerLoginField = registerLoginField;
	}
	...
	public JButton getRegisterGoBackToSignInButton() {
		return registerGoBackToSignInButton;
	}

	public void setRegisterGoBackToSignInButton(JButton registerGoBackToSignInButton) {
		this.registerGoBackToSignInButton = registerGoBackToSignInButton;
	}

	public JButton getRegisterSignUpButton() {
		return registerSignUpButton;
	}

	public void setRegisterSignUpButton(JButton registerSignUpButton) {
		this.registerSignUpButton = registerSignUpButton;
	}
	...
	private void initialize() {
		...
		this.setLoginRegisterNewAccountButton(new JButton("register a new account"));
		...
		this.setLoginSignInButton(new JButton("Sign in"));
		...
		this.setRegisterGoBackToSignInButton(new JButton("go back to sign in window"));
		...
		this.setRegisterSignUpButton(new JButton("Sign up"));
